...
Avoids the cryptography C-extension dependency for environments where
the system package is broken. Docker builds install a full cryptography
wheel, so this is fine in production too.
"""
import base64
import hashlib
import hmac
